...
#define SensorI2CAddress 0x??  // This is the default address for the 7021 Sensor.
Adafruit_Si7021 sensor = Adafruit_Si7021();
#define LCDI2CAddress 0x??  // This is the address for the LCD display (can vary).
...
void loop() {
  // Some possibly useful examples - Remove once your program is working!
	...
	// To write to the terminal.  You can send characters inside of "double quotes"
	//   Serial.print();
	//   Serial.println();
...
void findI2CAddresses() {
	// Leveraged from https://learn.adafruit.com/scanning-i2c-addresses/arduino?gad_source=1&gclid=Cj0KCQiAn-2tBhDVARIsAGmStVlEmMDNCvjza_EptvBgsr6ucvNK5ZlaAZ7JAfS3WR0jNmUUabE9-ecaArEgEALw_wcB
  byte error, address;
  int nDevices;
